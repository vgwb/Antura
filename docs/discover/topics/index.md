...
- Connected cards:
    ...
    ![preview waves](../../assets/img/discover/cards/waves.jpg){ width="200" }
    ...
    ![preview ship](../../assets/img/discover/cards/ship.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview mountain_guide](../../assets/img/discover/cards/mountain_guide.jpg){ width="200" }

    - **[Hiking](../cards/index.md#hiking)** (RelatedTo)
    Walking on trails in nature.

    ![preview hiking](../../assets/img/discover/cards/hiking.jpg){ width="200" }

    - **[Climbing](../cards/index.md#climbing)** (RelatedTo)
    Going up rocks or ice with special gear.

    ![preview climbing](../../assets/img/discover/cards/climbing.jpg){ width="200" }

    - **[Skiing](../cards/index.md#skiing)** (RelatedTo)
    Sliding on snow with skis.

    ![preview skiing](../../assets/img/discover/cards/skiing.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview piano](../../assets/img/discover/cards/piano.jpg){ width="200" }

    - **[A](../cards/index.md#note_la)** (RelatedTo)
    A musical note.

    ![preview note_la](../../assets/img/discover/cards/note_la.jpg){ width="200" }

    - **[F](../cards/index.md#note_fa)** (RelatedTo)
    A musical note.

    ![preview note_fa](../../assets/img/discover/cards/note_fa.jpg){ width="200" }

    - **[B](../cards/index.md#note_si)** (RelatedTo)
    A musical note.

    ![preview note_si](../../assets/img/discover/cards/note_si.jpg){ width="200" }

    - **[G](../cards/index.md#note_sol)** (RelatedTo)
    A musical note.

    ![preview note_sol](../../assets/img/discover/cards/note_sol.jpg){ width="200" }

    - **[C](../cards/index.md#note_do)** (RelatedTo)
    A musical note.

    ![preview note_do](../../assets/img/discover/cards/note_do.jpg){ width="200" }

    - **[E](../cards/index.md#note_mi)** (RelatedTo)
    A musical note.

    ![preview note_mi](../../assets/img/discover/cards/note_mi.jpg){ width="200" }

    - **[D](../cards/index.md#note_re)** (RelatedTo)
    A musical note.

    ![preview note_re](../../assets/img/discover/cards/note_re.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview nicolaus_copernicus](../../assets/img/discover/cards/nicolaus_copernicus.jpg){ width="200" }

    - **[Eyepiece](../cards/index.md#eyepiece)** (RelatedTo)
    The small lens you look through on a telescope.

    ![preview eyepiece](../../assets/img/discover/cards/eyepiece.jpg){ width="200" }

    - **[Lens](../cards/index.md#lens)** (RelatedTo)
    A clear piece of glass or plastic that bends light.

    ![preview lens](../../assets/img/discover/cards/lens.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview animal_elephant](../../assets/img/discover/cards/animal_elephant.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview person_baker](../../assets/img/discover/cards/person_baker.jpg){ width="200" }

    - **[SALT](../cards/index.md#food_salt)** (MadeOf)
    White crystals that make food taste better. 

    ![preview food_salt](../../assets/img/discover/cards/food_salt.jpg){ width="200" }

    - **[Yeast](../cards/index.md#food_yeast)** (MadeOf)
    Yeast is like magic powder that makes bread soft and tasty!

    ![preview food_yeast](../../assets/img/discover/cards/food_yeast.jpg){ width="200" }

    - **[Flour](../cards/index.md#food_flour)** (MadeOf)
    White powder made from wheat that is used to make bread.

    ![preview food_flour](../../assets/img/discover/cards/food_flour.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview food_bread](../../assets/img/discover/cards/food_bread.jpg){ width="200" }
    ...
    ![preview food_pepper_salt](../../assets/img/discover/cards/food_pepper_salt.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview country_switzerland](../../assets/img/discover/cards/country_switzerland.jpg){ width="200" }

    - **[Luxembourg](../cards/index.md#country_luxembourg)** (RelatedTo)
    A country in Europe. Capital is Luxembourg City.

    ![preview country_luxembourg](../../assets/img/discover/cards/country_luxembourg.jpg){ width="200" }
    ...
    ![preview country_germany](../../assets/img/discover/cards/country_germany.jpg){ width="200" }

    - **[Spain](../cards/index.md#country_spain)** (RelatedTo)
    A country in Europe. Capital is Madrid. Spain invented flamenco dancing.

    ![preview country_spain](../../assets/img/discover/cards/country_spain.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview gustave_eiffel](../../assets/img/discover/cards/gustave_eiffel.jpg){ width="200" }
    ...
    ![preview iron_material](../../assets/img/discover/cards/iron_material.jpg){ width="200" }
    ...
    ![preview eiffel_tower_map](../../assets/img/discover/cards/eiffel_tower_map.jpg){ width="200" }
    ...
    ![preview eiffel_tower_ticket](../../assets/img/discover/cards/eiffel_tower_ticket.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview education_ecole_maternelle_fr](../../assets/img/discover/cards/education_ecole_maternelle_fr.jpg){ width="200" }
    ...
    ![preview education_ecole_primaire_fr](../../assets/img/discover/cards/education_ecole_primaire_fr.jpg){ width="200" }
    ...
    ![preview education_lycee_fr](../../assets/img/discover/cards/education_lycee_fr.jpg){ width="200" }
    ...
    ![preview education_college_fr](../../assets/img/discover/cards/education_college_fr.jpg){ width="200" }
    ...
    ![preview concept_cursive_writing](../../assets/img/discover/cards/concept_cursive_writing.jpg){ width="200" }
    ...
    ![preview object_canteen_menu](../../assets/img/discover/cards/object_canteen_menu.jpg){ width="200" }
    ...
    ![preview concept_charter_of_secularism](../../assets/img/discover/cards/concept_charter_of_secularism.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview book_around_the_world_80_days](../../assets/img/discover/cards/book_around_the_world_80_days.jpg){ width="200" }
    ...
    ![preview book_from_earth_to_moon](../../assets/img/discover/cards/book_from_earth_to_moon.jpg){ width="200" }
    ...
    ![preview book_20000_leagues_under_the_sea](../../assets/img/discover/cards/book_20000_leagues_under_the_sea.jpg){ width="200" }

    - **[Hot-Air Balloon](../cards/index.md#hot_air_balloon)** (RelatedTo)
    A balloon that flies using hot air. The first one flew in France.

    ![preview hot_air_balloon](../../assets/img/discover/cards/hot_air_balloon.jpg){ width="200" }

    - **[Space Rocket](../cards/index.md#space_rocket)** (RelatedTo)
    A rocket that goes into space.

    ![preview space_rocket](../../assets/img/discover/cards/space_rocket.jpg){ width="200" }
    ...
    ![preview submarine_nautilus](../../assets/img/discover/cards/submarine_nautilus.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview person_cheesemonger](../../assets/img/discover/cards/person_cheesemonger.jpg){ width="200" }
    ...
    ![preview person_greengrocer](../../assets/img/discover/cards/person_greengrocer.jpg){ width="200" }

    - **[Grocer](../cards/index.md#person_grocer)** (RelatedTo)
    A person who sells many kinds of food and drinks.

    ![preview person_grocer](../../assets/img/discover/cards/person_grocer.jpg){ width="200" }

    - **[Fishmonger](../cards/index.md#person_fishmonger)** (RelatedTo)
    A person who sells fresh fish and seafood.

    ![preview person_fishmonger](../../assets/img/discover/cards/person_fishmonger.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview french_revolution](../../assets/img/discover/cards/french_revolution.jpg){ width="200" }

    - **[Le jour de la gloire](../cards/index.md#marseillaise_3)** (RelatedTo)
    Words from the anthem’s first line.

    ![preview marseillaise_3](../../assets/img/discover/cards/marseillaise_3.jpg){ width="200" }

    - **[Allons enfants](../cards/index.md#marseillaise_1)** (RelatedTo)
    The first words of the anthem’s first line.

    ![preview marseillaise_1](../../assets/img/discover/cards/marseillaise_1.jpg){ width="200" }

    - **[De la patrie](../cards/index.md#marseillaise_2)** (RelatedTo)
    Words from the anthem’s first line.

    ![preview marseillaise_2](../../assets/img/discover/cards/marseillaise_2.jpg){ width="200" }

    - **[Est arrivé](../cards/index.md#marseillaise_4)** (RelatedTo)
    Words from the anthem’s first line.

    ![preview marseillaise_4](../../assets/img/discover/cards/marseillaise_4.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview wind](../../assets/img/discover/cards/wind.jpg){ width="200" }

    - **[Summit](../cards/index.md#summit)** (RelatedTo)
    The very top of a mountain.

    ![preview summit](../../assets/img/discover/cards/summit.jpg){ width="200" }

    - **[Alps](../cards/index.md#alps)** (RelatedTo)
    A tall mountain range in Europe.

    ![preview alps](../../assets/img/discover/cards/alps.jpg){ width="200" }
    ...
    ![preview snow](../../assets/img/discover/cards/snow.jpg){ width="200" }

    - **[Ice](../cards/index.md#ice)** (RelatedTo)
    Frozen water that can be very slippery.

    ![preview ice](../../assets/img/discover/cards/ice.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview notre_dame_de_paris_fire](../../assets/img/discover/cards/notre_dame_de_paris_fire.jpg){ width="200" }
    ...
    ![preview ile_de_france](../../assets/img/discover/cards/ile_de_france.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview place_bridge_people](../../assets/img/discover/cards/place_bridge_people.jpg){ width="200" }
    ...
    ![preview place_bridge_trains](../../assets/img/discover/cards/place_bridge_trains.jpg){ width="200" }

    - **[River boat](../cards/index.md#boat_river)** (RelatedTo)
    A boat that travels on rivers. Rivers are like roads made of water!

    ![preview boat_river](../../assets/img/discover/cards/boat_river.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview gdansk_lighthouse](../../assets/img/discover/cards/gdansk_lighthouse.jpg){ width="200" }

    - **[Motława River](../cards/index.md#motawa_river)** (RelatedTo)
    The river that runs through Gdańsk to the sea.

    ![preview motawa_river](../../assets/img/discover/cards/motawa_river.jpg){ width="200" }

    - **[Baltic Sea Coast](../cards/index.md#baltic_sea_coast)** (RelatedTo)
    The sandy shore along the Baltic Sea.

    ![preview baltic_sea_coast](../../assets/img/discover/cards/baltic_sea_coast.jpg){ width="200" }
    ...
    ![preview baltic_sea](../../assets/img/discover/cards/baltic_sea.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview place_vistula_river](../../assets/img/discover/cards/place_vistula_river.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview pierogi](../../assets/img/discover/cards/pierogi.jpg){ width="200" }
    ...
    ![preview currency_zloty](../../assets/img/discover/cards/currency_zloty.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview country_slovakia](../../assets/img/discover/cards/country_slovakia.jpg){ width="200" }

    - **[Czech Republic](../cards/index.md#country_czech_republic)** (RelatedTo)
    A country in Europe. Capital is Prague.

    ![preview country_czech_republic](../../assets/img/discover/cards/country_czech_republic.jpg){ width="200" }

    - **[Lithuania](../cards/index.md#country_lithuania)** (RelatedTo)
    A country in Europe. Capital is Vilnius.

    ![preview country_lithuania](../../assets/img/discover/cards/country_lithuania.jpg){ width="200" }
    ...
    ![preview country_russia](../../assets/img/discover/cards/country_russia.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview capital_warsaw](../../assets/img/discover/cards/capital_warsaw.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview mermaid_of_warsaw](../../assets/img/discover/cards/mermaid_of_warsaw.jpg){ width="200" }
    ...
    ![preview wars_and_sawa](../../assets/img/discover/cards/wars_and_sawa.jpg){ width="200" }
    ...
    ![preview fryderyk_chopin](../../assets/img/discover/cards/fryderyk_chopin.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview animal_lover_dwarf](../../assets/img/discover/cards/animal_lover_dwarf.jpg){ width="200" }

    - **[Bishop Dwarf](../cards/index.md#bishop_dwarf)** (RelatedTo)
    A dwarf statue who asks a church question.

    ![preview bishop_dwarf](../../assets/img/discover/cards/bishop_dwarf.jpg){ width="200" }

    - **[Dwarf Expert](../cards/index.md#dwarf_expert)** (RelatedTo)
    A friendly guide who knows all about the dwarfs.

    ![preview dwarf_expert](../../assets/img/discover/cards/dwarf_expert.jpg){ width="200" }

    - **[Keymaster Dwarf](../cards/index.md#keymaster_dwarf)** (RelatedTo)
    A dwarf statue guarding the elevator with a big key.

    ![preview keymaster_dwarf](../../assets/img/discover/cards/keymaster_dwarf.jpg){ width="200" }
    ...
    ![preview polish_dwarf](../../assets/img/discover/cards/polish_dwarf.jpg){ width="200" }

    - **[Wrocław Dwarf Statue](../cards/index.md#wroclaw_dwarf_statue)** (RelatedTo)
    A small city statue; dwarfs are Wrocław’s symbol.

    ![preview wroclaw_dwarf_statue](../../assets/img/discover/cards/wroclaw_dwarf_statue.jpg){ width="200" }
...
- Connected cards:
    ...
    ![preview zoo_keeper](../../assets/img/discover/cards/zoo_keeper.jpg){ width="200" }

    - **[Animal Enclosure](../cards/index.md#animal_enclosure)** (RelatedTo)
    A safe space made for animals to live at the zoo.

    ![preview animal_enclosure](../../assets/img/discover/cards/animal_enclosure.jpg){ width="200" }

    - **[Zoo Director](../cards/index.md#zoo_director)** (RelatedTo)
    The person who runs the zoo and helps visitors.

    ![preview zoo_director](../../assets/img/discover/cards/zoo_director.jpg){ width="200" }
