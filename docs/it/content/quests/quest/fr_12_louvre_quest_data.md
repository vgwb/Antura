---
title: Museo del Louvre (fr_12_louvre_quest_data)
hide:
---

# Museo del Louvre (fr_12_louvre_quest_data)
...
- Difficulty: Normal
- Duration (min): 15
- Description: Scopri il museo più famoso del mondo e Leonardo Da Vinci!
...
#### Connection (PartOf): part of the museum collection - Monna Lisa
...
#### Connection (PartOf): part of the museum collection - La libertà che guida il popolo
...
#### Connection (PartOf): part of the museum collection - Venere di Milo
