...
- Difficulty: Normal
- Duration (min): 20
- Description: Esplora i diversi livelli del sistema scolastico francese, dalla maternelle al lycée, per trovare il tuo posto in una tipica giornata alla scuola primaria.
...
#### Connection (Purpose): tool used for math - Compasso
