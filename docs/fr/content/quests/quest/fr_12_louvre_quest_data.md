---
title: Musée du Louvre (fr_12_louvre_quest_data)
hide:
---

# Musée du Louvre (fr_12_louvre_quest_data)
...
- Difficulty: Normal
- Duration (min): 15
- Description: Découvrez le musée le plus célèbre du monde et Léonard de Vinci !
...
#### Connection (PartOf): part of the museum collection - La Joconde
...
#### Connection (RelatedTo): associated artist - Léonard de Vinci
...
#### Connection (PartOf): part of the museum collection - La liberté guidant le peuple
...
#### Connection (PartOf): part of the museum collection - Vénus de Milo
