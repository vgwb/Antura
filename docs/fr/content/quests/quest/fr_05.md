...
- Difficulty: Normal
- Duration (min): 10
- Description: Voyagez dans la vallée de la Loire pour visiter deux châteaux très différents : une forte forteresse défensive et un magnifique palais royal
...
![preview castle_chinon](../../../../assets/img/content/cards/castle_chinon.jpg){ width="200" }
- Type: Place
- Subjects: History
