...
- Difficulty: Normal
- Duration (min): 15
- Description: Découvrez les véhicules emblématiques de Jules Verne, des sous-marins aux fusées, tout en apprenant des choses sur ses romans visionnaires et le vocabulaire du voyage.
...
#### Connection (RelatedTo) - Le tour du monde en quatre-vingts jours
...
#### Connection (RelatedTo) - De la Terre à la Lune
...
#### Connection (RelatedTo) - Vingt Mille Lieues sous les mers
...
#### Connection (RelatedTo) - Cinq semaines en ballon
...
#### Connection (RelatedTo) - Fusée spatiale
...
#### Connection (RelatedTo) - Sous-marin (Le Nautilus)
...
#### Connection (RelatedTo) - Montgolfière
