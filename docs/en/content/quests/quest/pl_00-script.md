...
<span class="yarn-line">Let's meet friends from nearby countries.</span> <span class="yarn-meta">#line:0862117</span>
...
<span class="yarn-line">You discovered a part of Central Europe!</span> <span class="yarn-meta">#line:031f72c </span>
...
<span class="yarn-line">    Warsaw is the capital of Poland!</span> <span class="yarn-meta">#line:09d7771 </span>
...
<span class="yarn-line">    Can you help our German friends?</span> <span class="yarn-meta">#line:04bd4db #task:talk_npc_germany</span>
...
<span class="yarn-line">    Can you help us?</span> <span class="yarn-meta">#line:08a2f6d</span>
...
<span class="yarn-line">Find the polish flag. It's white and red.</span> <span class="yarn-meta">#line:09e3b54 #task:find_flag_poland</span>
...
<span class="yarn-cmd">&lt;&lt;target NPC_poland&gt;&gt;</span>
<span class="yarn-line">You found the Polish flag! Go back to Poland.</span> <span class="yarn-meta">#line:0891273 </span>
...
<span class="yarn-line">    You found the Polish flag! Go back to Poland.</span> <span class="yarn-meta">#shadow:0891273 </span>
    <span class="yarn-cmd">&lt;&lt;inventory flag_poland add&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;target npc_poland&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
...
<span class="yarn-line">    Can you help my belarusian friend?</span> <span class="yarn-meta">#line:06c463a #task:talk_npc_belarus</span>
...
<span class="yarn-line">Find the German flag. It's black, red, and yellow.</span> <span class="yarn-meta">#line:029ee72 #task:find_flag_germany</span>
...
<span class="yarn-cmd">&lt;&lt;target NPC_Germany&gt;&gt;</span>
<span class="yarn-line">You found the German flag! Go back to Germany.</span> <span class="yarn-meta">#shadow:05f0ed2</span>
...
<span class="yarn-line">    Can you help my czech friend?</span> <span class="yarn-meta">#line:021e1a2 #task:talk_npc_czech</span>
...
<span class="yarn-line">Find the belarusian flag and bring it back.</span> <span class="yarn-meta">#line:0c00afe #task:find_flag_belarus</span>
...
<span class="yarn-cmd">&lt;&lt;target NPC_Belarus&gt;&gt;</span>
<span class="yarn-line">You found the Belarusian flag! Go back to the Belarus.</span> <span class="yarn-meta">#shadow:0157c15 </span>
...
<span class="yarn-line">    You found the Belarusian flag! Go back to the Belarus.</span> <span class="yarn-meta">#line:0157c15 </span>
    <span class="yarn-cmd">&lt;&lt;inventory flag_belarus add&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;target NPC_Belarus&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
...
<span class="yarn-line">    Thank you! Our capital is Prague!</span> <span class="yarn-meta">#line:08473de </span>
...
<span class="yarn-line">    Help our lithuanian friends!</span> <span class="yarn-meta">#line:0a1e0a3 #task:talk_npc_lithuania</span>
...
<span class="yarn-line">    Czechia is famous for its beautiful castles, crystal glass, and delicious dumplings!</span> <span class="yarn-meta">#line:03dc09c </span>
    <span class="yarn-cmd">&lt;&lt;jump task_czech_republic&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
<span class="yarn-line">    My flag is white and red with a blue triangle.</span> <span class="yarn-meta">#line:0000741 </span>
<span class="yarn-cmd">&lt;&lt;endif&gt;&gt;</span>
...
<span class="yarn-line">Find the Czech flag and bring it back.</span> <span class="yarn-meta">#line:0ff23aa #task:find_flag_czech</span>
...
<span class="yarn-line">You found the Czech flag! Go back to Czech Republic.</span> <span class="yarn-meta">#shadow:0a134f5 </span>
...
<span class="yarn-line">    You found the Czech flag! Go back to Czech Republic.</span> <span class="yarn-meta">#line:0a134f5 </span>
    <span class="yarn-cmd">&lt;&lt;inventory flag_czech_republic add&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;target NPC_Czech&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
...
<span class="yarn-line">    Vilnius is the capital of Lithuania.</span> <span class="yarn-meta">#line:0acbb04 </span>
...
<span class="yarn-line">    Can you help my Ukrainian friend?</span> <span class="yarn-meta">#line:0bcf83b #task:talk_npc_ukraine</span>
...
<span class="yarn-line">Find the Lithuanian flag and bring it back.</span> <span class="yarn-meta">#line:0b88326 #task:find_flag_lithuania</span>
...
<span class="yarn-cmd">&lt;&lt;target NPC_Lithuania&gt;&gt;</span>
<span class="yarn-line">You found the Lithuanian flag! Go back to Lithuania.</span> <span class="yarn-meta">#shadow:069f1a0 </span>
...
<span class="yarn-line">    You found the Lithuanian flag! Go back to Lithuania.</span> <span class="yarn-meta">#line:069f1a0 </span>
    <span class="yarn-cmd">&lt;&lt;inventory flag_lithuania add&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;target npc_lithuania&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
<span class="yarn-line">    Flag of Lithuania.</span> <span class="yarn-meta">#line:0a3e2f1</span>
<span class="yarn-cmd">&lt;&lt;endif&gt;&gt;</span>
...
<span class="yarn-line">    Can you help my slovakian friend?</span> <span class="yarn-meta">#line:0aa87ef #task:talk_npc_slovakia</span>
...
<span class="yarn-line">    Hi! I’m from Ukraine!</span> <span class="yarn-meta">#line:07ea99a </span>
...
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
<span class="yarn-line">    Our flag is blue and yellow.</span> <span class="yarn-meta">#line:0a94866 </span>
<span class="yarn-cmd">&lt;&lt;endif&gt;&gt;</span>
...
<span class="yarn-line">Find the flag of Ukraine. It is blue and yellow.</span> <span class="yarn-meta">#line:07c148b #task:find_flag_ukraine</span>
...
<span class="yarn-cmd">&lt;&lt;target NPC_ukraine&gt;&gt;</span>
<span class="yarn-line">You found the Ukrainian flag! Go back to Ukraine.</span> <span class="yarn-meta">#shadow:0f8bc9d </span>
...
<span class="yarn-line">    You found the Ukrainian flag! Go back to Ukraine.</span> <span class="yarn-meta">#line:0f8bc9d </span>
    <span class="yarn-cmd">&lt;&lt;inventory flag_ukraine add&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;target NPC_ukraine&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
...
<span class="yarn-line">    Thank you for bringing our flag back!</span> <span class="yarn-meta">#line:0d453e9 </span>
...
<span class="yarn-comment">    // &lt;&lt;task_start talk_npc_russia&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;target NPC_Poland&gt;&gt;</span>
<span class="yarn-line">    Go back to the start and get your prize!</span> <span class="yarn-meta">#line:07b7f05 #task:talk_npc_poland_final</span>
...
<span class="yarn-line">Find the Slovakian flag.</span> <span class="yarn-meta">#line:04b6692 #task:find_flag_slovakia</span>
...
<span class="yarn-cmd">&lt;&lt;target NPC_Slovakia&gt;&gt;</span>
<span class="yarn-line">You found the Slovakian flag! Go back to Slovakia.</span> <span class="yarn-meta">#shadow:0c95e0a </span>
...
<span class="yarn-line">    You found the Slovakian flag! Go back to Slovakia.</span> <span class="yarn-meta">#line:0c95e0a </span>
    <span class="yarn-cmd">&lt;&lt;inventory flag_slovakia add&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;target NPC_Slovakia&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
...
<span class="yarn-line">    The capital of Russia is Moscow!</span> <span class="yarn-meta">#line:0f8817a </span>
...
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
<span class="yarn-line">    Our flag is red with a white cross.</span> <span class="yarn-meta">#line:05e0820 </span>
<span class="yarn-cmd">&lt;&lt;endif&gt;&gt;</span>
...
<span class="yarn-line">Find the Russian flag</span> <span class="yarn-meta">#line:06442e4 </span>
<span class="yarn-line">It's white, blue and red.</span> <span class="yarn-meta">#line:0c6ba5e </span>
...
<span class="yarn-line">You found the Russian flag! Go back to Russia.</span> <span class="yarn-meta">#shadow:0d1a793 </span>
...
<span class="yarn-line">    You found the Russian flag! Go back to Russia.</span> <span class="yarn-meta">#line:0d1a793 </span>
    <span class="yarn-cmd">&lt;&lt;inventory flag_russia add&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;target NPC_Russia&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
<span class="yarn-line">    Flag of russia.</span> <span class="yarn-meta">#line:00f1fcc</span>
<span class="yarn-cmd">&lt;&lt;endif&gt;&gt;</span>
...
<span class="yarn-header-dim">---</span>
<span class="yarn-line">In Europe, people speak over 50 languages!</span> <span class="yarn-meta">#line:04f4280 </span>
<span class="yarn-line">In Europe you can move freely between countries!</span> <span class="yarn-meta">#line:08d624d</span>
