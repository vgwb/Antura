...
<span class="yarn-line">Welcome to the French Alps!</span> <span class="yarn-meta">#line:start_1</span>
<span class="yarn-cmd">&lt;&lt;card place_mont_blanc&gt;&gt;</span>
<span class="yarn-line">Today we climb Mont Blanc. It is the highest mountain in the Alps.</span> <span class="yarn-meta">#line:start_2</span>
...
<span class="yarn-header-dim">---</span>
<span class="yarn-cmd">&lt;&lt;card place_mont_blanc&gt;&gt;</span>
<span class="yarn-line">Amazing! You reached the top of Mont Blanc. It is 4807 meters high!</span> <span class="yarn-meta">#line:end_1</span>
<span class="yarn-line">The Alps are full of tall, beautiful mountains.</span> <span class="yarn-meta">#line:end_2</span>
...
<span class="yarn-header-dim">color: red</span>
<span class="yarn-header-dim">---</span>
<span class="yarn-line">Draw Mont Blanc and the three flags in your notebook!</span> <span class="yarn-meta">#line:post_1</span>
...
<span class="yarn-line">    I see you have the backpack. Now you can go!</span> <span class="yarn-meta">#line:04c1c1f </span>
    <span class="yarn-cmd">&lt;&lt;card place_mont_blanc&gt;&gt;</span>
<span class="yarn-line">    Let's climb Mont Blanc.</span> <span class="yarn-meta">#line:0f4644b </span>
    <span class="yarn-cmd">&lt;&lt;card climbing&gt;&gt;</span>
<span class="yarn-line">    Find all the climbing gear and learn about the three nearby countries!</span> <span class="yarn-meta">#line:07f2699 </span>
...
<span class="yarn-line">    Come back when you finish the task.</span> <span class="yarn-meta">#line:046eb33 </span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;card mountain_guide&gt;&gt;</span>
<span class="yarn-line">    Help! I am a mountain guide. A blue dog took our climbing gear!</span> <span class="yarn-meta">#line:0724de3 </span>
<span class="yarn-line">    We saw the dog run up the mountain.</span> <span class="yarn-meta">#line:01beb5e </span>
    <span class="yarn-cmd">&lt;&lt;camera_focus camera_mont_blanc&gt;&gt;</span>
<span class="yarn-line">    Please explore Mont Blanc and find our gear.</span> <span class="yarn-meta">#line:0650acc </span>
    <span class="yarn-cmd">&lt;&lt;card backpack&gt;&gt;</span>
<span class="yarn-line">    Before going, you need a backpack.</span> <span class="yarn-meta">#line:045409f</span>
    <span class="yarn-cmd">&lt;&lt;camera_focus camera_intro&gt;&gt;</span>
<span class="yarn-line">    Look around for it!</span> <span class="yarn-meta">#line:05cabb5 </span>
...
<span class="yarn-line">    It opens! It contains a backpack.</span> <span class="yarn-meta">#line:0c1f006 </span>
...
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
<span class="yarn-line">    It's locked. Maybe you need a key.</span> <span class="yarn-meta">#line:chest_locked </span>
<span class="yarn-cmd">&lt;&lt;endif&gt;&gt;</span>
...
<span class="yarn-header-dim">---</span>
<span class="yarn-cmd">&lt;&lt;card backpack&gt;&gt;</span>
<span class="yarn-line">This backpack can carry food, water, and a map.</span> <span class="yarn-meta">#line:05e80cb </span>
...
<span class="yarn-line">Now we can exit the base camp and start the adventure!</span> <span class="yarn-meta">#line:029f39c</span>
<span class="yarn-cmd">&lt;&lt;target npc_intro&gt;&gt;</span>
...
<span class="yarn-line">    You are now ready to climb!</span> <span class="yarn-meta">#line:015bf8a</span>
    <span class="yarn-cmd">&lt;&lt;camera_focus camera_snowman&gt;&gt;</span>
<span class="yarn-line">    If you are blocked, the snowman can help!</span> <span class="yarn-meta">#line:showman_help</span>
...
<span class="yarn-line">    You are missing the coat!</span> <span class="yarn-meta">#line:03dd802 </span>
    <span class="yarn-cmd">&lt;&lt;target coat&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;card wind&gt;&gt;</span>
<span class="yarn-line">    The wind is starting to blow. My ears need protection!</span> <span class="yarn-meta">#line:b1_1</span>
<span class="yarn-line">    How do we protect the ears when the wind is strong?</span> <span class="yarn-meta">#line:b1_q</span>
...
<span class="yarn-header-dim">group: base_1</span>
<span class="yarn-header-dim">---</span>
<span class="yarn-line">Open the chest to get a warm hat!</span> <span class="yarn-meta">#line:0e83480 #task:get_hat</span>
<span class="yarn-cmd">&lt;&lt;set $step_base1 = 1&gt;&gt;</span>
...
<span class="yarn-cmd">&lt;&lt;if has_item("key_gold")&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;inventory key_gold remove&gt;&gt;</span>
<span class="yarn-line">    It opens! It contains some equipment.</span> <span class="yarn-meta">#line:056ec2b </span>
...
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
<span class="yarn-line">    It's locked. Maybe you need a key.</span> <span class="yarn-meta">#shadow:chest_locked </span>
<span class="yarn-cmd">&lt;&lt;endif&gt;&gt;</span>
...
<span class="yarn-line">This coat keeps you warm in wind and snow.</span> <span class="yarn-meta">#line:0e23f1f </span>
...
<span class="yarn-line">A warm hat keeps your head warm.</span> <span class="yarn-meta">#line:000fc05 </span>
<span class="yarn-line">It also helps when the wind is cold.</span> <span class="yarn-meta">#line:059d744</span>
<span class="yarn-cmd">&lt;&lt;inventory hat add&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;SetActive this false&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;task_end get_hat&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;target npc_base_1&gt;&gt;</span>
<span class="yarn-line">Now you can continue the climb!</span> <span class="yarn-meta">#line:0a7146f </span>
...
<span class="yarn-line">    You are now ready to climb!</span> <span class="yarn-meta">#shadow:015bf8a</span>
<span class="yarn-line">    If you get stuck, the snowman can help!</span> <span class="yarn-meta">#line:fr08_b2_help</span>
...
<span class="yarn-line">    Come back when you finish the task.</span> <span class="yarn-meta">#shadow:046eb33 </span>
<span class="yarn-cmd">&lt;&lt;elseif !has_item("sunglasses")&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;card sun&gt;&gt;</span>
<span class="yarn-line">    The sun on the snow is very bright. We need eye protection.</span> <span class="yarn-meta">#line:029a03e </span>
    <span class="yarn-cmd">&lt;&lt;card snow&gt;&gt;</span>
<span class="yarn-line">    What protects your eyes from bright snow and sun?</span> <span class="yarn-meta">#line:0a70f7d </span>
    <span class="yarn-cmd">&lt;&lt;activity fr08_activity_2 activity_2_done&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;elseif !has_item("gloves")&gt;&gt;</span>
<span class="yarn-line">    You are missing the gloves!</span> <span class="yarn-meta">#line:06b3363 </span>
    <span class="yarn-cmd">&lt;&lt;target gloves&gt;&gt;</span>
<span class="yarn-cmd">&lt;&lt;else&gt;&gt;</span>
<span class="yarn-line">    Keep looking. We still need all the gear.</span> <span class="yarn-meta">#line:keep_looking</span>
<span class="yarn-cmd">&lt;&lt;endif&gt;&gt;</span>
...
<span class="yarn-header-dim">group: base_2</span>
<span class="yarn-header-dim">---</span>
<span class="yarn-line">Open the chest to get sunglasses!</span> <span class="yarn-meta">#line:0fdc3cb </span>
<span class="yarn-cmd">&lt;&lt;set $step_base2 = 1&gt;&gt;</span>
...
<span class="yarn-cmd">&lt;&lt;if has_item("key_gold")&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;inventory key_gold remove&gt;&gt;</span>
<span class="yarn-line">    It opens! It has sunglasses inside.</span> <span class="yarn-meta">#line:fr08_b2_chest </span>
...
<span class="yarn-line">Snow and ice reflect bright sunlight.</span> <span class="yarn-meta">#line:02a2ea9 </span>
<span class="yarn-cmd">&lt;&lt;card sunglasses&gt;&gt;</span>
<span class="yarn-line">Sunglasses protect your eyes.</span> <span class="yarn-meta">#line:088fb7f</span>
...
<span class="yarn-line">    You have the ice gear. One last push to the top!</span> <span class="yarn-meta">#line:06b15bb </span>
...
<span class="yarn-line">    You are missing the rope!</span> <span class="yarn-meta">#line:0c18c08 </span>
...
<span class="yarn-header-dim">group: base_3</span>
<span class="yarn-header-dim">---</span>
<span class="yarn-line">Open the chest to get crampons!</span> <span class="yarn-meta">#line:02c9805 </span>
<span class="yarn-cmd">&lt;&lt;set $step_base3 = 1&gt;&gt;</span>
...
<span class="yarn-cmd">&lt;&lt;if has_item("key_gold")&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;inventory key_gold remove&gt;&gt;</span>
<span class="yarn-line">    It opens! It contains some equipment.</span> <span class="yarn-meta">#shadow:056ec2b </span>
...
<span class="yarn-line">You made it! We are at the top of Mont Blanc.</span> <span class="yarn-meta">#line:030fa1c </span>
<span class="yarn-line">This summit is 4807 meters high.</span> <span class="yarn-meta">#line:018880a </span>
<span class="yarn-line">Let's answer three mountain questions before the flag game.</span> <span class="yarn-meta">#line:001e940 </span>
...
<span class="yarn-line">France is west of Mont Blanc.</span> <span class="yarn-meta">#line:0d23529 </span>
...
<span class="yarn-line">Italy is east of Mont Blanc.</span> <span class="yarn-meta">#line:050fe70  </span>
...
<span class="yarn-line">Switzerland is north of Mont Blanc.</span> <span class="yarn-meta">#line:03db010  </span>
...
<span class="yarn-line">I sleep all winter under the snow. This is called hibernation!</span> <span class="yarn-meta">#line:fr08_marmot_2 #card:marmot</span>
<span class="yarn-line">I love eating alpine flowers and grass. Yum!</span> <span class="yarn-meta">#line:fr08_marmot_3 #card:marmot</span>
<span class="yarn-line">Don't mind me, I'm just sunbathing on this warm rock.</span> <span class="yarn-meta">#line:fr08_marmot_4 #card:marmot</span>
...
<span class="yarn-cmd">&lt;&lt;if has_item("key_gold")&gt;&gt;</span>
    <span class="yarn-cmd">&lt;&lt;inventory key_gold remove&gt;&gt;</span>
<span class="yarn-line">    You found a warm scarf!</span> <span class="yarn-meta">#line:003e87c </span>
...
<span class="yarn-line">Mont Blanc is the highest mountain in the Alps!</span> <span class="yarn-meta">#line:003ecb2 </span>
<span class="yarn-line">I hope to see a marmot!</span> <span class="yarn-meta">#line:04bbada #card:marmot</span>
<span class="yarn-line">Don't forget to bring warm clothes!</span> <span class="yarn-meta">#line:0590129 </span>
<span class="yarn-line">Mountains can be dangerous, so be careful!</span> <span class="yarn-meta">#line:097ecf0 </span>
...
<span class="yarn-header-dim">---</span>
<span class="yarn-line">Hiking here needs good boots.</span> <span class="yarn-meta">#line:0dbac73 #card:hiking</span>
<span class="yarn-line">The wind can change fast.</span> <span class="yarn-meta">#line:0557ef5 #card:wind</span>
<span class="yarn-line">I follow the rope line when it is icy.</span> <span class="yarn-meta">#line:0bc67f7 #card:rope</span>
<span class="yarn-line">That glacier looks like a frozen river.</span> <span class="yarn-meta">#line:01e5f66 #card:glacier</span>
...
<span class="yarn-header-dim">---</span>
<span class="yarn-line">I love climbing in the Alps.</span> <span class="yarn-meta">#line:0809dce #card:alps</span>
<span class="yarn-line">Crampons help me walk on hard ice.</span> <span class="yarn-meta">#line:081fbe4 #card:crampons</span>
<span class="yarn-line">Climbing with a guide is safer.</span> <span class="yarn-meta">#line:0371d31 #card:mountain_guide</span>
