...
#### Connection (RelatedTo) - Kupiec handlujący serem
...
#### Connection (RelatedTo) - Właściciel sklepu spożywczego
...
#### Connection (MadeOf) - Pomarańczowy
