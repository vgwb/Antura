...
- Difficulty: Normal
- Duration (min): 15
- Description: Odkryj kultowe pojazdy Juliusza Verne’a, od łodzi podwodnych po rakiety, poznaj jego wizjonerskie powieści i dowiedz się więcej o słownictwie związanym z podróżami.
...
#### Connection (RelatedTo) - W osiemdziesiąt dni dookoła świata
...
#### Connection (RelatedTo) - Z Ziemi na Księżyc
...
#### Connection (RelatedTo) - 20 000 mil podmorskiej żeglugi
...
#### Connection (RelatedTo) - Pięć tygodni w balonie
...
#### Connection (RelatedTo) - Rakieta kosmiczna
...
#### Connection (RelatedTo) - Łódź podwodna (Nautilus)
...
#### Connection (RelatedTo) - Balon na ogrzane powietrze
