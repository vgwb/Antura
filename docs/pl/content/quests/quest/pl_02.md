...
#### Core Card - Krasnale wrocławskie
...
#### Connection (RelatedTo) - Ekspert Krasnoludów
...
#### Connection (RelatedTo) - Krasnolud Klucznik
...
#### Connection (RelatedTo) - Rzeźba Krasnala wrocławskiego
