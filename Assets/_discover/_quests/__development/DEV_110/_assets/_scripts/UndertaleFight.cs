...
namespace Antura.Discover.DEV110
{
    ...
    public class UndertaleFight : MonoBehaviour
    {
        ...
        public enum FightState { Inactive, Menu, ActSelect, Dialogue, Dodge, Ended }
        ...
        private IEnumerator RunDodge(string waveId)
        {
            ...
            if (wave.BulletPrefab == null || DodgeBox == null || Soul == null)
            {
                Debug.LogWarning("UndertaleFight: dodge wave missing BulletPrefab / DodgeBox / Soul.");
                yield break;
            }
        ...
        /// <summary>Finish the fight. <paramref name="win"/> true = spared/won, false = lost.</summary>
