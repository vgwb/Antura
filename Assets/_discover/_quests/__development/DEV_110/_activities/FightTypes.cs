...
namespace Antura.Discover.DEV110
{
    ...
    public class DodgeWave
    {
        ...
        [Tooltip("Authored projectile pattern (made with the Projectile Pattern Designer). If set, this " +
                 "wave plays the pattern and every field below is ignored. No bullet prefab needed.")]
        public ProjectilePattern Pattern;

        [Tooltip("Legacy: bullet prefab (must have a FightBullet + RectTransform). Only used when Pattern is empty.")]
